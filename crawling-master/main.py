...
if __name__ == "__main__":
    # 테스트
    # test = pd.read_excel('C:/DEV/crawling/data/testData/ticketPerformance_20250512_160139.xlsx')
    # test.to_sql(name='ticket_tbl', con=DB_CONNECTION_STR,  if_exists='append',index=False)
    main()